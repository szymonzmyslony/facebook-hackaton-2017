...
const defaultStyles = {
  container: { backgroundColor: "#E9E9EF" },
  textInputContainer: {
  ...
  powered: {},
  listView: {},
  row: { height: 25, flexDirection: "row" },
  separator: {},
  description: { color: "#424242", fontSize: 15, fontWeight: "300" },
  loader: {
    // flex: 1,
    flexDirection: "row",
    justifyContent: "flex-end",
...
const GooglePlacesAutocomplete = React.createClass({
  ...
  getDefaultProps() {
    return {
      ...
      query: { key: "missing api key", language: "en", types: "geocode" },
    ...
    return (
      <View style={[defaultStyles.container, this.props.styles.container]}>
        <View style={{ marginHorizontal: 30 }}>
          ...
          >
            <Text style={{ fontSize: 16, color: "#959595", fontWeight: "600" }}>
              Suggested
            </Text>
          </View>
          {this._getListView()}
